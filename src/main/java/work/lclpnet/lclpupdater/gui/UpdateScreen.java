package work.lclpnet.lclpupdater.gui;
...
public class UpdateScreen extends Screen {
    ...
    protected void init() {
        ...
        addButton(new ButtonWidget(this.width / 2 - 100, (int) (this.height * 0.45), 200, 20, updateComponent, obj -> Helper.startLCLPLauncher().thenRun(() -> {
            if (this.client != null) {
                this.client.stop();
            }
        }).exceptionally(err -> {
        ...
        addButton(new ButtonWidget(this.width / 2 - 100, (int) (this.height * 0.55), 200, 20, cancelComponent, obj -> this.client.stop()));
    }
